...
<?php 
	...
	if($_POST["looking_for"] == ""){
	?>
	  </p>
	<form id="lookforPatient" name="lookforPatient" method="post" action="">
	  <p>Ingrese Rut:
	</p>
	  <p>
	    <label>
  ...
  <?php
		...
		try{
			$doc = $client->getDoc($looking_for);
			
			echo '<tr>
						<td bordercolor="#CCCCCC">'.$doc->_id.'</td>
						<td bordercolor="#CCCCCC">'.$doc->apellido_paterno.' '.$doc->apellido_materno.', '.$doc->nombre.'</td>
						<td bordercolor="#CCCCCC" align="center"><a class="detalles" href="detalles_paciente.php?view='.$doc->_id.'"><img src="images/icons/Zoom.png" width="32" height="32" alt="Detalles Paciente" /></a></td>
						<td bordercolor="#CCCCCC" align="center">';
			if($_SESSION["level"] > 1){
				echo '		<a class="detalles" href="detalles_clinicos.php?view='.$doc->_id.'"><img src="images/icons/Health.png" width="32" height="32" alt="Detalles Clinicos" /></a>';
			}
			echo '		</td>
						<td bordercolor="#CCCCCC" align="center"><a class="sube_examen" href="agregar_examen.php?view='.$doc->_id.'"><img src="images/icons/Report-Add.png" width="32" height="32" alt="Agregar Examenes" /></a></td>
						<td bordercolor="#CCCCCC" align="center">';
			if($_SESSION["level"] > 1){
				echo '<a class="examenes" href="examenes.php?view='.$doc->_id.'"><img src="images/icons/Report.png" width="32" height="32" alt="Examenes" /></a>';
			}
			echo '</td>
					</tr>';
				...
				if ( $e->getCode() == 404 ) {
					echo '<tr><td colspan="6">No se encontro el Paciente.</td></tr>';	
				}
			}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td><div align="center">
      ...
      It's True Services - Web Development
</p>
    </div></td>
  </tr>
</table>
